...
void void __attribute__((vector(_TIMER_2_VECTOR), interrupt(ipltmr2AUTO),
...
void void __attribute__((vector(_TIMER_3_VECTOR), interrupt(ipltmr3AUTO),
...
void void __attribute__((vector(_TIMER_4_VECTOR), interrupt(ipltmr4AUTO),
...
void void __attribute__((vector(_TIMER_5_VECTOR), interrupt(ipltmr5AUTO),
...
void void __attribute__((vector(_TIMER_6_VECTOR), interrupt(ipltmr6AUTO),
...
void void __attribute__((vector(_TIMER_7_VECTOR), interrupt(ipltmr7AUTO),
...
void void __attribute__((vector(_TIMER_8_VECTOR), interrupt(ipltmr8AUTO),
...
void void __attribute__((vector(_TIMER_9_VECTOR), interrupt(ipltmr9AUTO),
