...
void sysclk_init(void)
{
  ...
  PRECONbits.PFMSECEN   = 0;        /* Do not generate interrupt when PFMSECbit
                                     * is set */
  PRECONbits.PREFEN     = 0b11;     /* Predictive prefech Enable (for any
                                     * address) */
  PRECONbits.PFMWS      = 0b010;    /* PFM Access Time Defined in Terms of
                                     * SYSCLK Wait States */
